...
public:
    CTestNetParams() {
        ...
        // reward setting
        consensus.premine = int64_t(6e8 * COIN);
        // premine
        consensus.genesisReward = int64_t(1 * COIN);                        // genesis                                                           
        consensus.minerReward4 = int64_t(73.648 * COIN);                   // miners
        consensus.foundersReward = int64_t(20833333.333 * COIN);             // founders
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("compute.amazonaws.com","ec2-13-125-241-139.ap-northeast-2.compute.amazonaws.com"));
        vSeeds.push_back(CDNSSeedData("compute.amazonaws.com","ec2-52-78-140-219.ap-northeast-2.compute.amazonaws.com"));
        ...
        fRequireStandard = true;
        fMineBlocksOnDemand = false;
        fTestnetToBeDeprecatedFieldRPC = true; //chan mainet true
